...
execute_process(
  COMMAND "/usr/bin/git" show-ref "d9e4955c65cd4367dd6bf46f4ccb8cd3d100540b"
  WORKING_DIRECTORY "/root/workspace/tflite_build_docker/abseil-cpp"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d9e4955c65cd4367dd6bf46f4ccb8cd3d100540b")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d9e4955c65cd4367dd6bf46f4ccb8cd3d100540b" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/d9e4955c65cd4367dd6bf46f4ccb8cd3d100540b")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/workspace/tflite_build_docker/abseil-cpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/workspace/tflite_build_docker/abseil-cpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
