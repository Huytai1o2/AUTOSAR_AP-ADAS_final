...
execute_process(
  COMMAND "/usr/bin/git" show-ref "585e73e63cb35c8a416c83a48ca9ab79f7f7d45e"
  WORKING_DIRECTORY "/root/workspace/tflite_build_docker/xnnpack"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "585e73e63cb35c8a416c83a48ca9ab79f7f7d45e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("585e73e63cb35c8a416c83a48ca9ab79f7f7d45e" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/585e73e63cb35c8a416c83a48ca9ab79f7f7d45e")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/workspace/tflite_build_docker/xnnpack'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/workspace/tflite_build_docker/xnnpack'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
