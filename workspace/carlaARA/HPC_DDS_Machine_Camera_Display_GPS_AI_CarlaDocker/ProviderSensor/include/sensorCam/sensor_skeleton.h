...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SENSORCAM_SERVICE_INTERFACE_SENSOR_SKELETON_H
#define PARA_COM_GEN_SENSORCAM_SERVICE_INTERFACE_SENSOR_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit imageDataEvent(para::com::SkeletonInterface* interface, para::com::SkeletonDdsInterface* ddsInterface, para::com::ServiceProtocol protocol)
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            {
                mDdsInterface->CreateEvent<dds::sensorCam::imageDataEventType>(kCallSign);
                break;
            }
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::sensorCam::imageDataEventType _event_;
                _event_.instance_id() = mDdsInterface->GetInstanceId();
                _event_.data() = imageData_ConvertToDdsType(data);
                return mDdsInterface->SendEvent<dds::sensorCam::imageDataEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
...
public:
    ...
    SensorSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
        ...
        , imageDataEvent(mInterface.get(), mDdsInterface.get(), mProtocol)
    {
        switch (mProtocol)
        {
            case para::com::ServiceProtocol::kSomeIp :
...
private:
    void HandlerequestData(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        ...
        if (result.HasValue())
        {
            ...
            para::serializer::Serializer serializer{};
            serializer.write(props, output.imageDataOut);
    ...
    {
        dds::sub::DataReader<dds::sensorCam::SensorMethod_Request> _reader_ = reader;
        dds::sub::LoanedSamples<dds::sensorCam::SensorMethod_Request> _requests_;
    ...
    #endif /// PARA_DDS_IMPLEMENTATION
    #ifdef PARA_DDS_IMPLEMENTATION
    void HandlerequestData(const dds::sensorCam::SensorMethod_requestData_In& data, const dds::rpc::RequestHeader token)
    {
        dds::sensorCam::SensorMethod_requestData_Result _result_{};
        bool _isRequest = data.isRequest();
        auto future = this->requestData(_isRequest);
        auto result = future.GetResult();
        if (result.HasValue())
        {
            dds::sensorCam::SensorMethod_requestData_Out _out_args_;
            _out_args_.imageDataOut() = imageData_ConvertToDdsType(result.Value().imageDataOut);
        ...
        dds::sensorCam::SensorMethod_Return _return_;
        _return_.requestData(_result_, dds::sensorCam::SensorMethod_requestData_Hash);
        dds::sensorCam::SensorMethod_Reply _reply_;
        _reply_.data() = _return_;
        _reply_.header() = mDdsInterface->GetReplyHeader(token);
        mDdsInterface->ReturnMethod<dds::sensorCam::SensorMethod_Reply>(_reply_);
    }
    #endif /// PARA_DDS_IMPLEMENTATION
...
#endif /// PARA_COM_GEN_SENSORCAM_SERVICE_INTERFACE_SENSOR_SKELETON_H