...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SENSORCAM_SERVICE_INTERFACE_SENSOR_PROXY_H
#define PARA_COM_GEN_SENSORCAM_SERVICE_INTERFACE_SENSOR_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    using SampleType = imageData;
    /// @brief Constructor
    explicit imageDataEvent(para::com::ProxyInterface* interface, para::com::ProxyDdsInterface* ddsInterface, para::com::ServiceProtocol protocol)
    ...
    /// @brief Destructor
    virtual ~imageDataEvent() = default;
    /// @brief Delete copy constructor
    imageDataEvent(const imageDataEvent& other) = delete;
    /// @brief Delete copy assignment
    imageDataEvent& operator=(const imageDataEvent& other) = delete;
    /// @brief Move constructor
    imageDataEvent(imageDataEvent&& other) noexcept 
    ...
    imageDataEvent& operator=(imageDataEvent&& other) noexcept
    {
        mInterface = other.mInterface;
        mDdsInterface = other.mDdsInterface;
        mProtocol = other.mProtocol;
    ...
    ara::core::Result<void> Subscribe(size_t maxSampleCount)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                ...
                mMaxSampleCount = maxSampleCount;
                return mDdsInterface->SubscribeEvent<dds::sensorCam::imageDataEventType>(kCallSign, mMaxSampleCount);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
    ...
    ara::core::Result<size_t> GetNewSamples(F&& f, size_t maxNumberOfSamples = std::numeric_limits<size_t>::max())
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                auto samples = mDdsInterface->GetNewSamples<dds::sensorCam::imageDataEventType>(kCallSign, maxNumberOfSamples);
                for (const auto& sample : samples)
                {
                    SampleType data = imageData_ConvertFromDdsType(sample.data());
                    f(ara::com::make_sample_ptr<const SampleType>(data));
                }
                return samples.size();
            }
...
private:
    ...
    const std::string kCallSign = {"imageDataEvent"};
};
} /// namespace events
...
public:
    ...
    ara::core::Future<Output> operator()(const bool& isRequest)
    {
        ...
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::sensorCam::SensorMethod_requestData_In _in_args_;
                _in_args_.isRequest() = isRequest;
                dds::sensorCam::SensorMethod_Call _call_{};
                _call_.requestData(_in_args_, dds::sensorCam::SensorMethod_requestData_Hash);
                dds::sensorCam::SensorMethod_Request _request_{};
                _request_.header() = mDdsInterface->GetMethodRequestHeader();
                _request_.data() = _call_;
                mDdsInterface->CallMethod<dds::sensorCam::SensorMethod_Request>(_request_.header(), _request_, __promise__);
                break;
            }
            #endif /// PARA_DDS_IMPLEMENTATION
            default :
    ...
    void HandleMethodReturn(dds::ReturnCode_t result, const dds::sensorCam::SensorMethod_requestData_Result& data, void* userData)
    {
        auto* promise = static_cast<ara::core::Promise<requestData::Output>*>(userData);
        if (result == dds::RETCODE_OK)
        {
            dds::sensorCam::SensorMethod_requestData_Out _response_ = data.result();
            methods::requestData::Output _out_args_;
            _out_args_.imageDataOut = imageData_ConvertFromDdsType(_response_.imageDataOut());
...
private:
    static void HandleMethodReturn(std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData)
    {
        ...
        if (result == 0)
        {
            ...
            deserializer.read(props, output.imageDataOut);
...
public: 
    ...
    explicit SensorProxy(HandleType& handle)
        ...
        , imageDataEvent(mInterface.get(), mDdsInterface.get(), mHandle.GetServiceHandle().protocol)
        , requestData(mInterface.get(), mDdsInterface.get(), mHandle.GetServiceHandle().protocol)
    {
        ...
        {
            mDdsInterface->CreateMethods<dds::sensorCam::SensorMethod_Request, dds::sensorCam::SensorMethod_Reply>();
            auto methodReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::sensorCam::SensorMethod_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::sensorCam::SensorMethod_Reply> _samples_;
                ...
                for (auto& _sample_ : _samples_)
                {
                    if (_sample_.info().valid())
                    {
                        ...
                        switch (_return_._d())
                        {
                            case dds::sensorCam::SensorMethod_requestData_Hash :
                            {
            ...
            mDdsInterface->CreateFields<dds::sensorCam::SensorField_Request, dds::sensorCam::SensorField_Reply>();
            auto fieldReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::sensorCam::SensorField_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::sensorCam::SensorField_Reply> _samples_;
                _samples_ = _reader_.take();
                for (auto& _sample_ : _samples_)
                {
                    if (_sample_.info().valid())
    ...
    SensorProxy(SensorProxy&& other) noexcept
        ...
        , imageDataEvent(std::move(other.imageDataEvent))
...
public:
    /// @brief - event, imageDataEvent
    events::imageDataEvent imageDataEvent;
    /// @brief - method, requestData
    methods::requestData requestData;
};
} /// namespace proxy
} /// namespace sensorCam
#endif /// PARA_COM_GEN_sensorCam_SERVICE_INTERFACE_SENSOR_PROXY_H