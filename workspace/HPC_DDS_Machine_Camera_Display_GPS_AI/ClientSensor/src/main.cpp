...
clientsensor::aa::ClientSensor* g_swcClientSensor{nullptr};
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("cSen", "ClientSensor's main function")};
        ...
        clientsensor::aa::ClientSensor swcClientSensor;
