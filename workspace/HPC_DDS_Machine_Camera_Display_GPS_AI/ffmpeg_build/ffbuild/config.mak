...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/root/workspace/deps/ffmpeg --cross-prefix=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu- --arch=aarch64 --target-os=linux --enable-cross-compile --enable-static --disable-shared --enable-pic --disable-programs --disable-doc --disable-debug --disable-network --disable-x86asm
...
INSTALL_NAME_DIR=
SRC_PATH=/root/workspace/ffmpeg
SRC_LINK=src
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
CXX=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-g++
AS=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
OBJCC=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
LD=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
DEPCC=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-ar
NM_CMD=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-nm -g
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-ranlib -D
STRIP=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
...
LD_PATH=-L
DLLTOOL=
WINDRES=/opt/cross-pi-gcc-12.2.0-64/bin/aarch64-linux-gnu-windres
DOXYGEN=doxygen
