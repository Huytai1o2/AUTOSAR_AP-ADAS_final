...
public:
    ...
    ara::core::Result<void> Subscribe(size_t maxSampleCount)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                ...
                mMaxSampleCount = maxSampleCount;
                return mDdsInterface->SubscribeEvent<dds::sensor::transv2::SensorVectorTypeEventType>(kCallSign, mMaxSampleCount);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
    ...
    ara::core::Result<size_t> GetNewSamples(F&& f, size_t maxNumberOfSamples = std::numeric_limits<size_t>::max())
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                auto samples = mDdsInterface->GetNewSamples<dds::sensor::transv2::SensorVectorTypeEventType>(kCallSign, maxNumberOfSamples);
                for (const auto& sample : samples)
                {
...
public:
    ...
    void HandleMethodReturn(dds::ReturnCode_t result, const dds::sensor::transv2::transferData_v2Method_RequestData_Result& data, void* userData)
    {
        ...
        if (result == dds::RETCODE_OK)
        {
            ...
            _out_args_.outputVector = ara::sensor::SensorVectorType_ConvertFromDdsType(_response_.outputVector());
