...
/// EXECUTABLE NAME                   : ProviderSensor
...
providersensor::rootswcomponent::ProviderSensor* g_swcProviderSensor{nullptr};
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("PVSENSR", "ProviderSensor's main function")};
        ...
        providersensor::rootswcomponent::ProviderSensor swcProviderSensor;
        g_swcProviderSensor = &swcProviderSensor;
        
        // initialize software component
        proceed = swcProviderSensor.Initialize();
        
        if (proceed)
        {
            // start software component
            swcProviderSensor.Start();
