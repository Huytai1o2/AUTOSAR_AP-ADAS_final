...
providersensor::aa::ProviderSensor* g_swcProviderSensor{nullptr};
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("pSen", "ProviderSensor's main function")};
        ...
        providersensor::aa::ProviderSensor swcProviderSensor;
